...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns'=>array(
            ...
            array(
                ...
                'type'=>'html',
                'value'=> '
                            CHtml::link(CHtml::tag("img",array("src"=>Yii::app()->createUrl("pic/send", array("id"=>$data->id,"size_folder"=>"thumbs")))),"",array("class"=>"fancyElm", "href"=>Yii::app()->createUrl("pic/send", array("id"=>$data->id,"size_folder"=>"orig"))))
                        ',
